    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OemNumbers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ProductOemNumbers",
                columns: table => new
                {
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    OemNumberId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOemNumbers", x => new { x.ProductId, x.OemNumberId });
                    table.ForeignKey(
                        name: "FK_ProductOemNumbers_OemNumbers_OemNumberId",
                        column: x => x.OemNumberId,
                        principalTable: "OemNumbers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductOemNumbers_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleEngines_VehicleGenerations_VehicleGenerationId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductVehicleCompatibilities",
                columns: table => new
                {
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVehicleCompatibilities", x => new { x.ProductId, x.VehicleEngineId });
                    table.ForeignKey(
                        name: "FK_ProductVehicleCompatibilities_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVehicleCompatibilities_VehicleEngines_VehicleEngineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserVehicles_VehicleEngines_VehicleEngineId",
                        column: x => x.VehicleEngineId,
                        principalTable: "VehicleEngines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OemNumbers_NormalizedNumber",
                table: "OemNumbers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOemNumbers_OemNumberId",
                table: "ProductOemNumbers",
                column: "OemNumberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVehicleCompatibilities_VehicleEngineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserVehicles_VehicleEngineId",
                table: "UserVehicles",
                column: "VehicleEngineId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleEngines_VehicleGenerationId",
