...
builder.Services.AddCors(options =>
{
    ...
    {
        var origins = builder.Configuration["Cors:AllowedOrigins"]?.Split(',') ?? ["http://localhost:3000"];
...
// Global exception handler — returns JSON instead of HTML for unhandled errors
